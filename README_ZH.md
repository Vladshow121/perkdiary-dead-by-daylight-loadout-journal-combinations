...
独立的项目设计文档，适用对象： **Dead by Daylight**。
...
- **技能组合笔记** (Perk combination notebook) — 规划模块，尚未实现。
- **角色专属配装标签** (Role-specific loadout tags) — 规划模块，尚未实现。
- **对局复盘日志** (Match review journal) — 规划模块，尚未实现。
